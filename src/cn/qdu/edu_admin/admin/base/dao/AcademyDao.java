...
public class AcademyDao {
    ...
    public int add(Academy academy){
        String sql = " INSERT INTO academy" + " (academyName,dean, tel, email, address)" + " VALUES(?,?,?,?,?)";
        int result =  runner.update( sql, 
                academy.getAcademyName(), academy.getDean(), academy.getTel(), academy.getEmail(), academy.getAddress());        
    ...
    public int update(Academy academy){
        String sql = " UPDATE academy SET " +  " academyName=?,dean=?, tel=?," + " email=?, address=? WHERE academyID = ?";
        int result = runner.update(sql, academy.getAcademyName(), academy.getDean(), academy.getTel(), academy.getEmail(), academy.getAddress(), academy.getAcademyId());   
