package cn.qdu.edu_admin.admin.base;
...
import cn.qdu.edu_admin.admin.base.dao.StudentInfoDao;
import cn.qdu.edu_admin.admin.base.service.StudentInfoService;
import cn.qdu.edu_admin.admin.conduct.service.ConductDataOutputService;
import cn.qdu.edu_admin.admin.scholarships.service.ScholarshipsDataOutputService;
import cn.qdu.edu_admin.domain.Admin;
import cn.qdu.edu_admin.domain.ConductVo;
import cn.qdu.edu_admin.domain.Score;
import cn.qdu.edu_admin.domain.Student;
import cn.qdu.edu_admin.domain.StudentVo;
import cn.qdu.edu_admin.util.DeCompressUtil;
import cn.qdu.edu_admin.util.ExportStudentInfos;
import cn.qdu.edu_admin.util.GenericUtil;
import cn.qdu.edu_admin.util.ReadExcel;
...
public class StudentInfoAction extends ActionSupport {
	...
	public void exportData() throws Exception{
		...
		String[] header = {"学号", "姓名" ,"性别" ,"班级" ,"入学年份" ,"宿舍 ","民族" ,"家庭出身", "教育程度" ,"身份证号","银行卡号","出生年月", "政治面貌" ,"手机","籍贯","邮政编码","家庭电话 ","家庭地址" };
	...
	public void updateStudentScore() throws Exception{
		...
		String makeup = req.getParameter("makeup");
		System.out.println("id:"+id+";qingkao="+makeup+"---");
		if(makeup==""){
			makeup = null;
		}
		ScholarshipsDataOutputService service = new ScholarshipsDataOutputService();
		String result = service.updateScoreById(id, grade, makeup);
