package cn.qdu.edu_admin.admin.system;
...
import cn.qdu.edu_admin.admin.system.service.AdminService;
import cn.qdu.edu_admin.domain.Admin;
import cn.qdu.edu_admin.domain.Menu;
...
public class AdminAction extends ActionSupport {
	...
	public String login(){
		...
		// basePath:   http://localhost:8080/edu_admin
		String basePath = req.getScheme()+"://"+req.getServerName()+":"+req.getServerPort()+path+"/";
		// adminPath:  http://localhost:8080/edu_admin/admin/
