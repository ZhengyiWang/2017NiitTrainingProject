package cn.qdu.edu_admin.admin.workstudy.service;

import java.util.List;

import cn.qdu.edu_admin.admin.workstudy.dao.WorkstudyDao;
import cn.qdu.edu_admin.domain.AllotInfo;
import cn.qdu.edu_admin.domain.ApplyInfo;
import cn.qdu.edu_admin.domain.JobArrange;
...
public class WorkstudyService {
	...
	public List<cn.qdu.edu_admin.domain.Class> queryClasses(int aRole, int aSubject) {
