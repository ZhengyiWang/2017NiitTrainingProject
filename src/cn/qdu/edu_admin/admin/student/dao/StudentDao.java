package cn.qdu.edu_admin.admin.student.dao;
	...
	public void addstudentToFamily(Student student, String householdType,
		...
		if (family != null) {
			String sql = "update family"
					+ " set householdType=?,familySize=?,monthlyIncome=?,"
					+ "comment=? where studentNum=? and schoolYear="
					+ "'" + date + "'";
			runner.update(sql, householdType, homenumber, everybodyGet,comment,
